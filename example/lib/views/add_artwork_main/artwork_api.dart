...
_uploadFood(Food food, bool isUpdating, Function foodUploaded, {String imageUrl}) async {
  ...
  // CollectionReference foodRef = db.collection('userData').;
...
deleteFood(Food food, Function foodDeleted) async {
  //if  (food.image = null){
  if ((food.image != null) && ("${food.uid}" == "test")) { //must have image and correct user
    // if (("${food.uid}" == "test")) { //must have image and correct user
