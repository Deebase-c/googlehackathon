...
class _SignUpViewState extends State<SignUpView> {
  ...
  List<Widget> buildInputs() {
    ...
    if ([AuthFormType.signUp, AuthFormType.convert].contains(authFormType)) {
      ...
      textFields.add(SizedBox(height: 5));
    }
  ...
  InputDecoration buildSignUpInputDecoration(String hint) => InputDecoration(
      hintText: hint,
      filled: true,
  ...
  Widget showForgotPassword(bool visible) => Visibility(
      child: FlatButton(
        child: Text(
          "Forgot Password?",
          style: TextStyle(color: Colors.white),
  ...
  Widget buildSocialIcons(bool visible) {
    final _auth = Prov.of(context).auth;
    return Visibility(
      child: Column(
